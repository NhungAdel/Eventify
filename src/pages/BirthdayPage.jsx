...
const BackLink = ({ to = "/", text = "Back" }) => (
  <Link
    to={to}
    className="hidden md:flex items-center gap-2 group text-black hover:text-[#d4a76a] transition-colors absolute top-36 left-6"
  >
    <svg
    ...
    <div>
      ...
      <div className="bg-[#a37a74] w-full text-3xl font-serif mb-6 md:mb-10 flex flex-col md:flex-row justify-between items-center p-4 md:p-6 shadow-xl relative">
        ...
        <div className="hidden md:flex gap-3">
          <Link
            to={"/event"}
            className="bg-white text-lg px-6 py-3 whitespace-nowrap"
          >
            Co pořádáme?
          </Link>
          <Link
      ...
      <div className="text-center mb-8 md:mb-10 px-4">
        <p className="text-xl md:text-3xl font-serif mb-2">
          VYTVOŘÍME PRO VÁS NEPOZAPOMENUTELNOU NAROZENINOVOU OSLAVU
        </p>
        <p className="max-w-3xl mx-auto text-base md:text-xl font-serif">
          NAŠE NAROZENINOVÉ OSLAVY JSOU PLNÉ ZÁBAVY, ORIGINALITY A RADOSTI.
          POSTARÁME SE O VŠE OD A DO Z, ABYSTE SI MOHLI UŽÍT SVŮJ DEN BEZ
          STAROSTÍ.
        </p>
      </div>
