...
const PRICING_ITEMS = [
  { title: "Organizace", price: 40000 },
  { title: "Technika", price: 15000 },
  { title: "Aktivity", price: 10000 },
  { title: "catering (osoba)", price: 700 },
];
    ...
    <div>
      ...
      <div className="text-center mb-8 md:mb-10 px-4">
        ...
        <p className="max-w-3xl mx-auto text-base md:text-xl font-serif">
          ...
          PROFESIONALITU S NEZAPOMENUTELNÝM ZÁŽITKEM. OD MALÝCH TEAMBUILDINGŮ PO
          VELKÉ KONFERENCE.
        </p>
      </div>
