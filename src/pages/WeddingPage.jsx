...
const PRICING_ITEMS = [
  { title: "Plán svatby", price: 50000 },
  { title: "Koordinátor", price: 15000 },
  { title: "Dekorace", price: 10000 },
  { title: "catering (osoba)", price: 800 },
  { title: "foto/video", price: 12000 },
];
    ...
    <div>
      ...
      <div className="text-center mb-8 md:mb-10 px-4">
        ...
        <p className="max-w-3xl mx-auto text-base md:text-xl font-serif">
          ...
          AGENTUŘE SE ZAMĚŘUJEME NA TO, ABY KAŽDÝ DETAIL ODPOVÍDAL PŘEDSTAVÁM
          NAŠICH KLIENTŮ.
        </p>
      </div>
